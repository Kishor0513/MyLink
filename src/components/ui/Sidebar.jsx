        ...
        >
            <div className="flex flex-col gap-6 items-center">
                {socials.map((social, index) => (
                    ...
                    >
                        {social.icon}
                        <span className="absolute left-full ml-4 px-2 py-1 bg-primary text-dark text-xs font-bold rounded opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none whitespace-nowrap">
                            {social.label}
                        </span>
                    </motion.a>
                ))}
