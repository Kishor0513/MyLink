...
const Navbar = ({ onOpenQR }) => {
    ...
    return (
        <motion.nav
            initial={{ y: -100 }}
            animate={{ y: 0 }}
            className={`fixed top-0 left-0 right-0 z-40 transition-all duration-500 ${scrolled ? 'py-4 bg-dark/70 backdrop-blur-xl border-b border-white/5' : 'py-6 bg-transparent'
                }`}
        >
            <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
                ...
                >
                    ...
                    <span className="text-primary group-hover:text-secondary transition-colors">.dev</span>
                </motion.a>
